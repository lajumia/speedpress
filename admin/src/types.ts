...
export interface SpeedPressOptions {
  ...
  general : {
    ...
    disable_block_library_css: boolean;
    heartbeat_dashboard_interval : any;
    heartbeat_editor_interval: any,
    heartbeat_frontend_interval : any,
    disable_svg_filters: boolean;
    disable_gutenberg_editor: boolean;
